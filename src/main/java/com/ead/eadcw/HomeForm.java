...
public class HomeForm extends javax.swing.JFrame {
    ...
    private void fReportMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fReportMenuItemActionPerformed
        try {
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://database1.cj2cyusy40x9.us-east-2.rds.amazonaws.com:3306/eadcw?zeroDateTimeBehavior=CONVERT_TO_NULL", "devrious", "Devrious_45")) {
